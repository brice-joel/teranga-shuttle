         ...
         <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
             ...
             <div class="p-4 md:p-5 text-center">
                 ...
                 <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Voulez-vous vraiment supprimer ce
                     trajet ? <br>
                     Les réservations associées à ce trajet seront supprimées
                     <br>
                     <span class="text-[10px]"> Cette opération est irreverssible</span>
                 </h3>
                 <form action="{{ $route }}" method="POST" class="inline-flex items-center">
                     @method('DELETE')
                     @csrf
