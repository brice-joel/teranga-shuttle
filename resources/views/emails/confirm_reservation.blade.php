    ...
    <div class="container">
        ...
        <!--
                                                                            <div class="details">
                                                                                ...
                                                                                <div class="info"><strong>Nom du Client:</strong> </div>
        ...
        <div class="details">
            <div>
                <a class="link_payment" href="{{ 'https://terangashuttle.com/reservation/' . $id }}">
                    Suivez ce lien pour payer votre réservation :
                </a>
            </div>
        </div>
