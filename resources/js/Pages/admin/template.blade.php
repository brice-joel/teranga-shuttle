...
<head>
    ...
    <title>admin-teranga-shuttle</title>
...
<body>
            ...
            <div class="px-3 py-3 lg:px-5 lg:pl-3">
                <div class="flex items-center justify-between">
                    <div class="flex items-center justify-start rtl:justify-end">
                        ...
                        <a href="https://terangashuttle.com/admin/dashboard" class="flex ms-2 md:me-24">
                            <img src="https://flowbite.com/docs/images/logo.svg" class="h-8 hidden me-3"
                                alt="Teranga shuttle Logo" />
                            <span
                                class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">Admin
                                - Teranga Shuttle</span>
                        </a>
                    </div>
                ...
                <ul class="space-y-2 font-medium">
                    ...
                    <li>
                        <a href="{{ route('admin.trajet.index') }}"
                            ...
                            <span class="flex-1 ms-3 whitespace-nowrap">Trajets</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('admin.reservation.index') }}"
                            ...
                            <span
                                class="hidden inline-flex items-center justify-center w-3 h-3 p-3 ms-3 text-sm font-medium text-blue-800 bg-blue-100 rounded-full dark:bg-blue-900 dark:text-blue-300">3</span>
                        </a>
                    </li>
                    <li>
    ...
    @endif
    <main class="mt-16 p-5 sm:ml-64">
        @yield('content')
    </main>
    <footer class="bg-gray-900 text-white">

        <p class="p-5 text-center">Copyright &copy; 2025 Teranga-shuttle</p>
    </footer>
